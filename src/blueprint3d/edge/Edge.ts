...
export class HalfEdge {
   ...
   */
  constructor(public wall: IWall, private front: boolean) {
  ...
  private computeTransforms(transform: any, invTransform: any, start: { x: number; y: number; }, end: { x: number; y: number; }) {
